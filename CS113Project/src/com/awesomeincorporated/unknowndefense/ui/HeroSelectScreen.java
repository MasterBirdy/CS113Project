...
public class HeroSelectScreen implements Screen 
{
	...
	public HeroSelectScreen(EverythingHolder everything, UnknownDefense game)
	{
...
//		this.batch = batch;
		...
		buttons[4] = new RoundButton(230, 200, (int)(diameter * 1.5f), everything.getObjectTexture("cancelbutton"));
		buttons[5] = new RoundButton(300, 200, (int)(diameter * 1.5f), everything.getObjectTexture("backbutton"));
