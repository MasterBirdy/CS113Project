...
//			System.out.println("GL ERROR " + gl.glGetError());
		...
		while (!isPaused && timeAccumulator > stepTime && running && ready && (everything.moreTurns() || !multiplayer))
		{
			sentTurn = false;
			sendTurn();
			update();
...
//		if (!isPaused && timeAccumulator > stepTime && running && ready && (everything.moreTurns() || !multiplayer))
//		{
